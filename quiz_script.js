 ...
 async function fetch_question(questionId, quizChoice) {
   ...
   if (quizChoice == "quiz1") {
     api_endpoint_url = 'https://my-json-server.typicode.com/Daniel-SJU/QuizQuestions/'
   }
   else if (quizChoice == "quiz2") {
     api_endpoint_url = 'https://my-json-server.typicode.com/Daniel-SJU/Quizquestions2/'
   }
 ...
 function handle_widget_event(e) {
   ...
   if (appState.current_view == "#question_view_Input") {
     if (e.target.dataset.action == "submit") {
 ...
 function setQuestionView(appState) {
   ...
   if (appState.current_model.questionType == "true_false") {
     ...
     appState.current_view = "#question_view_Input";
   }
